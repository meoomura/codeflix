...
public class CreateCategoryUseCaseTest {
    ...
    @Test
    public void giveAValidCommand_whenCallsCreateCategory_thenShouldReturnCategoryId(){
    ...
    @Test
    public void giveAValidCommandWithInactiveCategory_whenCallsCreateCategory_thenShouldReturnInactiveCategoryId(){
        final var expectedName = "Filmes";
        final var expectedDescription = "A categoria mais assistida";
