...
public class ListCategoriesUseCaseTest {
    ...
    @Test
    public void giveAValidQuery_whenCallsListCategories_thenShouldReturnCategories() {
    ...
    @Test
    public void giveAValidQuery_whenHasNoResult_thenShouldReturnEmptyCategories() {
    ...
    @Test
    public void giveAValidQuery_whenThrowsException_thenShouldReturnException() {
        final var expectedPage = 0;
        final var expectedPerPage = 10;
        final var expectedTerms = "";
        final var expectedSort = "createdAt";
